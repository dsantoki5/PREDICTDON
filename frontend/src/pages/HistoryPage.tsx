  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <h1 className="text-2xl font-display font-bold text-white tracking-tight">Prediction Audit Trail</h1>
        <p className="text-sm text-slate-400 mt-0.5">Chronological log of all model predictions and confidence ratings.</p>
      </div>
