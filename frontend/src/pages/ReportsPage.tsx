  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <h1 className="text-2xl font-display font-bold text-white tracking-tight">Analytics & Reporting Hub</h1>
        <p className="text-sm text-slate-400 mt-0.5">Export compliance-ready PDF reports and Excel workbooks.</p>
      </div>
