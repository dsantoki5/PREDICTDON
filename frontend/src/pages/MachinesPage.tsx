  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <h1 className="text-2xl font-display font-bold text-white tracking-tight">Fleet Registry</h1>
        <p className="text-sm text-slate-400 mt-0.5">Register, edit, and inspect all CNC machines in the plant floor.</p>
      </div>
