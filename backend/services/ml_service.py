"""
PredictCNC ML Service — Physical sensor telemetry validation and LightGBM inference dispatch.
"""
import os
import sys
import numpy as np
...
class MLService:
    ...
    def validate_inputs(
        ...
        """Strict physical range validation."""
        for name, val in [
    ...
    def run_prediction(
        ...
        """Executes inference using authoritative LightGBM 44-feature model."""
        cls.validate_inputs(
            air_temp=air_temp,
